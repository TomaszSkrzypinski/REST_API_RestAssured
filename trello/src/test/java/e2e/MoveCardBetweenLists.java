...
public class MoveCardBetweenLists extends BaseTest {
    ...
    private static String firsListId;
    ...
    public void addCardToFirstList(){
        ...
        Response response = given()
                .spec(reqSpec)
                .queryParam("name", "New card on first list")
                .queryParam("idList", firsListId)
                .when()
                .post(BASE_URL + CARDS)
                .then()
                .statusCode(200)
        ...
        assertThat(json.getString("name")).isEqualTo("New card on first list");
    ...
    public void movedCardToSecondList() {
        ...
        Response response = given()
                ...
                .queryParam("name", "Card moved to second list")
                .when()
        ...
        assertThat(json.getString("name")).isEqualTo("Card moved to second list");
    }
